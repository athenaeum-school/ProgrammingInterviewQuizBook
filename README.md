...
マルチスレッド
-----
* [Java]synchronizedとlockの説明
* [Java]２つのスレッドからsynchronizedメソッドを同時に呼び出すことは可能か？
* [C++]ロックを使ってスレッドセーフなSingletonクラスを実装
...
注意点: ただ書ければよいのではなく、抽象化やテストを想定してプログラムを設計実装することが求められます。
